 ...
 */
public class BaseGraph2 <NodeType, EdgeType extends Number> {
    ...
    public boolean containsNode(NodeType data) {
        //this method loops through each node and uses the .equals() method since the containsKey will return false
        //for two objects that are the same but have different references
        Set<NodeType> setOfKeys = nodes.keySet();
        Iterator<NodeType> itr = setOfKeys.iterator();
        while (itr.hasNext()) {
